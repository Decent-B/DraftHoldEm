...
- Separate Draft and betting content by phase and position without oval outline indicators; render Draft Token contributions as standalone diamond chips without boxes, and hide Draft order, market prompt, and spent-token markers when Poker betting begins.
- Keep the complete felt rail, seats, cards, position badges, and action dock inside 320x568 portrait and 667x375 landscape viewports without browser zoom; on portrait phones cap the felt at 260px high with 48px side clearance, and in heads-up landscape put player stations beside—not above or below—the centered table.
