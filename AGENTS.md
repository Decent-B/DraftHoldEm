...
- At every player count, advance both SB and BB one eligible seat every Draft round, recalculate UTG/Cutoff and first action from the current BB, and at 0 bids let the current BB pick before the current SB.
